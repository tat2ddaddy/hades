...
export default function TOS() {
    return (
        <div>
            ...
            <div style={style.title}>TERMS OF SERVICE</div>
            <Divider/>
            <div style={style.subtitle}>OVERVIEW</div>

            <div style={style.paragraph2}>
                This website is operated by Hades Active LLC . Throughout the site, the terms “we”, “us” and
                “our” refer
                to Hades Active. Hades Active offers this website, including all information, tools and services
            ...
            <div style={style.subtitle}>SECTION 1 - ONLINE STORE TERMS</div>

            <div style={style.paragraph2}>
                By agreeing to these Terms of Service, you represent that you are at least the
                age of majority in your
            ...
            <div style={style.subtitle}>SECTION 2 - GENERAL CONDITIONS</div>

            <div style={style.paragraph2}>
                We reserve the right to refuse service to anyone for any reason at any time.
                You understand that your content (not including credit card information), may be transferred
                un-encrypted and involve (a) transmissions over various networks; and (b) changes to conform and adapt
            ...
            <div style={style.subtitle}>SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</div>
            ...
            <div style={style.subtitle}>SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</div>
            ...
            <div style={style.subtitle}>SECTION 5 - PRODUCTS OR SERVICES (if applicable)</div>

            <div style={style.paragraph2}>
                Certain products or services may be available exclusively online through the
                website. These products or
            ...
            <div style={style.subtitle}>SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</div>

            <div style={style.paragraph2}>
                We reserve the right to refuse any order you place with us. We may, in our
                sole discretion, limit or
            ...
            <div style={style.subtitle}>SECTION 7 - OPTIONAL TOOLS</div>

            <div style={style.paragraph2}>
                We may provide you with access to third-party tools over which we neither
                monitor nor have any control
                nor input.
            ...
            <div style={style.subtitle}>SECTION 8 - THIRD-PARTY LINKS</div>
            ...
            <div style={style.subtitle}>SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</div>

            <div style={style.paragraph2}>
                If, at our request, you send certain specific submissions (for example contest
                entries) or without a
            ...
            <div style={style.subtitle}>SECTION 10 - PERSONAL INFORMATION</div>

            <div style={style.paragraph2}>
                Your submission of personal information through the store is governed by our
                Privacy Policy. To view our
                Privacy Policy.
            </div>

            <div style={style.subtitle}>SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</div>
            ...
            <div style={style.subtitle}>SECTION 12 - PROHIBITED USES</div>
            ...
            <div style={style.subtitle}>SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</div>
            ...
            <div style={style.paragraph2}>
                ...
                merchant ability, merchantable quality, fitness for a particular purpose, durability, title, and
                non-infringement.
                In no case shall Hades Active, our directors, officers, employees, affiliates, agents, contractors,
            ...
            <div style={style.subtitle}>SECTION 14 - INDEMNIFICATION</div>

            <div style={style.paragraph2}>
                You agree to indemnify, defend and hold harmless Hades Active and our parent,
                subsidiaries, affiliates,
                partners, officers, directors, agents, contractors, licencors, service providers, subcontractors,
            ...
            <div style={style.subtitle}>SECTION 15 - SEVER-ABILITY</div>
            ...
            <div style={style.paragraph2}>
                ...
                such determination shall not affect the validity and enforce-ability of any other remaining
                provisions.
            </div>

            <div style={style.subtitle}>SECTION 16 - TERMINATION</div>
            ...
            <div style={style.subtitle}>SECTION 17 - ENTIRE AGREEMENT</div>
            ...
            <div style={style.subtitle}>SECTION 18 - GOVERNING LAW</div>
            ...
            <div style={style.subtitle}>SECTION 19 - CHANGES TO TERMS OF SERVICE</div>
            ...
            <div style={style.subtitle}>SECTION 20 - CONTACT INFORMATION</div>

            <div style={style.paragraph2}>Questions about the Terms of Service should be sent to us at
                support@hadesactive.com.
            </div>
        </div>
    )
}
